...
import { ErrorRegister as Error } from "../types"
            ...
            {({ errors, isSubmitting }) => (
                <Form className="form">
                    <label className="form__login">Put yout email
                        <Field type="email" className={errors.email ? 'inputerror' : ''} placeholder='email' name="email" />
                    ...
                    <label className="form__login">Put your nickname
                        <Field type="text" className={errors.name ? 'inputerror' : ''} placeholder='nickname' name="name" />
